  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-neutral-300 bg-white text-sm font-semibold text-neutral-900 transition-colors hover:bg-neutral-100"
      >
        {lang === "en" ? "EN" : "中"}
      </button>
