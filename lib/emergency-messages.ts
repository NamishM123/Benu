...
export const EMERGENCY_MESSAGES: Record<string, string> = {
  ...
  fa: "🚨 توقف کنید — اگر در حال حاضر اورژانس پزشکی وجود دارد، فوراً با ۹۱۱ (آمریکا)، ۱۱۵ (ایران) یا شمارهٔ اورژانس محلی خود تماس بگیرید. اگر شما یا کسی همراه شما واکنش آلرژیک داشته است، همین حالا به یکی از کارکنان یا مدیر Shake Shake Fresh Noodle مراجعه کنید. اگر EpiPen در دسترس است، از آن استفاده کنید. چیز دیگری نخورید و ننوشید.\n\nمن Benu هستم، فقط یک دستیار منو — نمی‌توانم با موقعیت‌های پزشکی یا گزارش‌های حادثه برخورد کنم. لطفاً مستقیماً با خدمات اورژانس و مدیریت رستوران تماس بگیرید.",
